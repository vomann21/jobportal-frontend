...
export const getMyJobs = ()=>async(dispatch)=>{
    try
    {
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/job/getmy`;
...
export const createJob = (data)=>async(dispatch)=>{
    try{
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/job/create`;
...
export const deleteJob = (id)=>async(dispatch)=>{
    try{
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/job/delete/${id}`;
...
export const fetchJobs = (city,domain,keyword)=>async(dispatch)=>{
    try{
        ...
        let link = "https://jobportal-back-4.onrender.com/api/v1/job/getall?"
        let queryParams = []
        if(keyword)
        {
...
export const fetchSingleJob = (JobId)=>async(dispatch)=>{
    try{
         ...
         const Link = `https://jobportal-back-4.onrender.com/api/v1/job/getone/${JobId}`
         const response = await axios.get(Link,{
            withCredentials:true
         })
