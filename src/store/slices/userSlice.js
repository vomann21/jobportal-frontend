...
export const register = (data) =>async(dispatch)=>{
    ...
    try
    {
        let link = "https://jobportal-back-4.onrender.com/api/v1/user/register";
...
export const login = (data)=> async(dispatch)=>{
    try{
        ...
        let link = "https://jobportal-back-4.onrender.com/api/v1/user/login"
        const response = await axios.post(link,data,{
            withCredentials:true,
...
export const getUser = () =>async(dispatch)=>{
    try{
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/user/userdetails`;
...
export const signOut = ()=>async(dispatch)=>{
      try{
          const Link = `https://jobportal-back-4.onrender.com/api/v1/user/signout`;
