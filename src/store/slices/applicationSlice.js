...
export const fetchJobSeekerApplication = ()=>async(dispatch)=>{
    try{
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/application/jobseeker/getall`;
...
export const fetchEmployerApplication = ()=>async(dispatch)=>{
    try{
        dispatch(applicationSlice.actions.requestForMyApplications());
        const Link = `https://jobportal-back-4.onrender.com/api/v1/application/employer/getall`;
        const response = await axios.get(Link,{
            withCredentials:true,
        })
        dispatch(applicationSlice.actions.successForMyApplications(response.data));
...
export const deleteApplication = (id)=>async(dispatch)=>{
    try{
        ...
        const Link = `https://jobportal-back-4.onrender.com/api/v1/application/delete/${id}`;
...
export const postApplication =(data,jobId)=>async(dispatch)=>{
        try{
            ...
            const Link = `https://jobportal-back-4.onrender.com/api/v1/application/post/${jobId}`;
